package com.xiongtao.httprequest_proxy.network.help;

import com.xiongtao.httprequest_proxy.network.callback.ICallback;
import com.xiongtao.httprequest_proxy.network.http.IHttpRequest;
...
public class HttpHelper implements IHttpRequest {
    ...
    // 依赖倒置原则  面向高层 不面向具体细节
    // 定义一个业主，卖房的人
    private static IHttpRequest mIHttpRequest = null; //依赖倒置原则，依赖抽象不依赖具体
    ...
    public void post(String url, Map<String, Object> params, ICallback iCallback) {
        ...
        mIHttpRequest.post(url,params,iCallback);  // 业主1  业主2 业主3 OkHttp
    }
